...
flowplayer(function(api, root) {
   ...
   if (conf.poster) common.css(root, 'background-images', "url(" + conf.poster + ")");

   var bc = common.css(root, 'background-color'),
      has_bg = common.css(root, 'background-images') != "none" || bc && bc != "rgba(0, 0, 0, 0)" && bc != "transparent";
   ...
   if (typeof conf.splash === 'string') {
     common.css(root, 'background-images', "url('" + conf.splash + "')");
   }
